...
use super::targets::{ScrapingTarget, ScrapingCategory, ScrapingMethod};
...
pub const SCRAPING_TARGETS: &[ScrapingTarget] = &[
    // Batch 1: Images (50)
    STOCKSNAP, BURST, RESHOT, PICJUMBO, GRATISOGRAPHY, LIFE_OF_PIX, NEGATIVE_SPACE,
    FOODIESFEED, SKITTERPHOTO, CUPCAKE, ISO_REPUBLIC, SPLITSHIRE, LIBRESHOT, MAGDELEINE,
    KABOOMPICS, JAY_MANTRI, TRAVEL_COFFEE_BOOK, MOVEAST, STOKPIC, FOCA_STOCK,
    GOOD_STOCK_PHOTOS, BARN_IMAGES, FREELY_PHOTOS, DESIGNERSPICS, FREE_NATURE_STOCK,
    PUBLIC_DOMAIN_PICTURES, PXHERE, STOCKVAULT, FREERANGESTOCK, RGBSTOCK, MORGUEFILE,
    NEW_OLD_STOCK, PICKUP_IMAGE, MMT_STOCK, LOCK_AND_STOCK, PHOTOSTOCKEDITOR, STYLED_STOCK,
    SHOTSTASH, NAPPY, IWARIA, EPICANTUS, TOOKAPIC, SNAPWIRE_SNAPS, BUCKETLISTLY, AVOPIX,
    FANCYCRAVE, PICOGRAPHY, JESHOOTS, RAUMROT, ALBUMARIUM,
    // Batch 2: Images (36)
    GETREFE, ANCESTRY_IMAGES, OLD_BOOK_ILLUSTRATIONS, GETTY_OPEN, YALE_BEINECKE, PARIS_MUSEES,
    ESA_IMAGES, NOAA_PHOTOS, USFWS, NPS_PHOTOS, USGS_PHOTOS, CDC_PHIL, NIH_GALLERY,
    US_NAVY, US_AIR_FORCE, UN_PHOTOS, SUPERFAMOUS, REALISTIC_SHOTS, STARTUP_STOCK,
    PHOTO_COLLECTIONS, VINTAGE_STOCK, RETROGRAPHIC, OLD_DESIGN_SHOP, WOCINTECH, JOPWELL,
    CREATEHER_STOCK, ONE_MILLION_FREE, CROW_THE_STONE, TUMBLR_FREE_STOCK, PHOTORACK,
    FREEPHOTOS_CC, LITTLE_VISUALS, DEATH_TO_STOCK, SKYPIXEL, LIBRESTOCK, FINDA_PHOTO,
    // Batch 3: Videos (45)
    MIXKIT_VIDEOS, VIDEVO, LIFE_OF_VIDS, DAREFUL, VIDSPLAY, MAZWAI, MOTION_PLACES,
    SPLITSHIRE_VIDEOS, XSTOCKVIDEO, CLIPSTILL, ISO_REPUBLIC_VIDEOS, DISTILL, BEACHFRONT,
    MOTION_ARRAY, POND5_PD, PHIL_FRIED, VIDEEZY, IGNITE_MOTION, MONZOOM, STOCK_FOOTAGE_4_FREE,
    VYDA, CUTE_STOCK, MOTION_BACKGROUNDS, FREE_GREEN_SCREEN, BENCHART, PANZOID,
    FREE_HD_FOOTAGE, ORANGEHD, MOVIE_TOOLS, OPEN_VIDEO_PROJECT, FOOTAGE_ISLAND, FREE_FOOTAGE,
    GRAIN_FREE, FREE_STOCK_FOOTAGE_ARCHIVE, NASA_VIDEO, ESA_VIDEOS, HUBBLE_VIDEOS,
    NOAA_VIDEO, NPS_BROLL, OPEN_FOOTAGE, DISSOLVE_FREE, PRODUCTION_CRATE, ACTIONVFX,
    MOTION_ELEMENTS, VECTEEZY_VIDEOS,
    // Batch 4: Audio (47)
    MIXKIT_MUSIC, MIXKIT_SFX, MUSOPEN, FREE_PD, PDSOUNDS, SOUNDBIBLE, BBC_SFX, ZAPSPLAT,
    SOUNDJAY, UPPBEAT, BENSOUND, CHOSIC, AUDIONAUTIX, INCOMPETECH, PURPLE_PLANET,
    PARTNERS_IN_RHYME, SAMPLE_FOCUS, LOOPERMAN, SOUNDS_CRATE, SOUNDGATOR, GR_SITES,
    FREE_SOUND_EFFECTS, ORANGE_FREE_SOUNDS, NINETY_NINE_SOUNDS, FREE_SFX, FREE_SOUND_LIBRARY,
    NOISE_FOR_FUN, FLASH_KIT_SOUNDS, WAV_SOURCE, FREE_LOOPS, SAMPLESWAP, FESLIYAN,
    TABLA_FREE, FREE_STOCK_MUSIC, SILVERMAN_SOUND, DL_SOUNDS, FMA, CCMIXTER, JAMENDO,
    DIG_CCMIXTER, ARCHIVE_AUDIO, SOUNDCLOUD_CC, EPIDEMIC_FREE, ARTLIST_FREE, NCS,
    AUDIO_LIBRARY, POND5_AUDIO_PD,
    // Batch 5: 3D, Textures, Vectors, Game Assets (50)
    FREE3D, ARCHIVE3D, CGTRADER_FREE, TURBOSQUID_FREE, SKETCHFAB_FREE, CLARA_IO,
    RENDERHUB_FREE, SHARECG, THREED_WAREHOUSE, TEXTURECAN, TEXTURES_COM, THREED_TEXTURES,
    SHARE_TEXTURES, TEXTURE_NINJA, TEXTURELIB, POLYHAVEN_TEXTURES, AMBIENTCG, CGBOOKCASE,
    SVGREPO, ICONMONSTR, FLATICON_FREE, SIMPLE_ICONS, FEATHER_ICONS, HEROICONS,
    TABLER_ICONS, LUCIDE, PHOSPHOR_ICONS, BOOTSTRAP_ICONS, MATERIAL_ICONS, FREEPIK_FREE,
    VECTEEZY_FREE, UNDRAW, DRAWKIT, HUMAAANS, OPEN_DOODLES, ABSURD_DESIGN, IRA_DESIGN,
    STORYSET, BLUSH_DESIGN, KENNEY, OPENGAMEART, ITCH_IO_ASSETS, GAMEART2D, CRAFTPIX_FREE,
    GAME_ICONS, UNITY_STORE_FREE, QUATERNIUS, KAY_LOUSBERG,
];
