...
fn generate_spectrogram(input: &Path, output: &Path, options: &SpectrumOptions) -> Result<ToolOutput> {
    let filter = format!(
...
fn generate_frequency_bars(input: &Path, output: &Path, options: &SpectrumOptions) -> Result<ToolOutput> {
    let filter = format!(
...
fn generate_histogram(input: &Path, output: &Path, options: &SpectrumOptions) -> Result<ToolOutput> {
    let filter = format!(
