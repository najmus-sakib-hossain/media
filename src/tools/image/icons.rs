...
impl IconSize {
    ...
    pub fn apple_touch() -> Vec<IconSize> {
        vec![
            IconSize {
                size: 57,
                platform: IconPlatform::AppleTouch,
                suffix: "57x57",
            },
            IconSize {
                size: 60,
...
pub fn generate_icons_for_sizes<P: AsRef<Path>>(
    ...
    Ok(ToolOutput::success(format!("Generated {} icons", generated.len())).with_paths(generated))
}
...
pub fn generate_favicon<P: AsRef<Path>>(input: P, output: P) -> Result<ToolOutput> {
    ...
    for size in sizes {
        ...
        encoder
            .encode(&resized, size, size, image::ExtendedColorType::Rgba8)
...
pub fn generate_pwa_icons<P: AsRef<Path>>(input: P, output_dir: P) -> Result<ToolOutput> {
    ...
    Ok(ToolOutput::success(format!("Generated PWA icons and manifest")).with_paths(generated))
}
